...
# Migration Map from the Earlier `suggestions/` Bundle

| Earlier item | New treatment |
|---|---|
| `suggestions/` as authority | Reclassified as research/proposals |
| the earlier self-declared authority index | Replaced by `PROPOSAL_INDEX.md` |
| `DOCUMENTATION_VALIDATION.md` | Replaced by internal-only `BUNDLE_VALIDATION.md` |
| duplicate master architecture | Reduced to one `research_proposals/ARCHITECTURE_RESEARCH_AND_TARGET_PRINCIPLES.md` |
| proposal ADR 0001–0015 | Renamed to RFD/research notes; no project ADR numbers |
| moving “current HEAD” claim | Replaced by audited committed baseline `20ff7928ea2d1eac5d26f13c62d0cda9b86bc078`; later worktree changes are not baseline evidence |
| proposal CP5 ADR | Research deltas target real ADR 0025 |
| proposal parked-PTY ADR | Future deltas target real ADR 0028 |
| Rust 1.98/edition 2024 as baseline | Current repo recorded as Rust 1.96.1/edition 2021; newer toolchain is candidate only |
| Tokio/Wasmtime/SQLite/AccessKit as baseline | Candidate/deferred, not current dependencies |
| `termd/session-host/extension-host` | Candidate research topology, not current architecture |
