...
| [0012](adr/0012-first-party-ssh-and-session-launch-boundary.md) | SSH/session launch boundary | Use exact argv and system OpenSSH with provider-neutral descriptors; do not invent a shell command parser or embed provider credentials. |
