...
| [0012](adr/0012-first-party-ssh-and-session-launch-boundary.md) | SSH/session launch boundary (proposed) | ADR 0012 keeps D0/D3 review-gated; M3 now adds only a pure exact direct-SSH request/review binding with all authority disabled. No capability is enabled until protected acceptance and native evidence pass. |
