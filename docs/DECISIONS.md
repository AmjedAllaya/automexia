...
| [0012](adr/0012-first-party-ssh-and-session-launch-boundary.md) | SSH/session launch boundary (proposed) | The local schema-1 D0/D3 package/grant/platform/fixture contract and fail-closed test model are complete; no capability is enabled until ADR 0012 protected acceptance and native evidence gates pass. |
