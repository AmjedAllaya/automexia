...
| Run verification or understand release gates | [Testing overview](developer/testing-release.md), [CI implementation audit](CI-ASSURANCE.md), [CI/build performance plan](CI-BUILD-PERFORMANCE-PLAN.md), [complete testing and evidence contract](TESTING.md), [per-feature reinforcement plan](FEATURE-TEST-REINFORCEMENT.md) |
