...
| Review stabilization/S1/S2 status and external evidence | [Stabilization roadmap](STABILIZATION-ROADMAP.md), [S1 native/visual/resource/accessibility audit](research/S1-NATIVE-VISUAL-RESOURCE-ACCESSIBILITY-AUDIT.md), [S1/S2 implementation audit](research/S1-S2-IMPLEMENTATION-AUDIT.md) |
