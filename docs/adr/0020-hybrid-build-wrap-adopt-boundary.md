...
Proposed [ADR 0033](0033-optional-llm-orchestration-extension.md) later clarifies
that model/provider code belongs in a separately installed extension while a
pure domain-neutral workflow contract may be shared below deterministic domains.
