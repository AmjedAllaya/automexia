...
D6.1/M8 AWS source contracts are complete locally and nonactivated; D6.2-D6.5
and all product/native provider evidence remain planned or external. D6.0/M7's
authority-free capsule/authentication framework is complete locally, while D6.1
adds no live provider login or command execution around the protected runner. Its reusable
