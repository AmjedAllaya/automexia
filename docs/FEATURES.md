...
| Native command completion and future Quick Actions | **CP1 shipped; CP2.0 model and CP2.1 persistence foundation implemented:** native-owned PowerShell/Bash/Zsh/Fish adapters, CMD fallback, explicit bounded official-provider cache, capability-free typed action model, and app-owned private atomic/CAS/last-known-good storage plus bounded exact watching. CP2.1 is not started or shown in the UI; CP2.2 UI/insertion, CP3 aliases, and CP5 suggestions are not shipped | PR: CP0/CP1 policy mutations; CP2.0 hostile/limit/round-trip tests; CP2.1 25 unit + 4 public integration/property cases, capability ratchet, controlled benchmark, native hosted matrix; planned CP2.2/CP3 UI/projection/native-shell/accessibility gates; planned CP5 protocol/fuzz/performance/resource gates | [Command Productivity](COMMAND-PRODUCTIVITY.md), [DevOps aliases](DEVOPS-ALIASES.md), [compatibility](COMMAND-PRODUCTIVITY-COMPATIBILITY.md), [shell integration](SHELL-INTEGRATION.md), [threat model](COMMAND-PRODUCTIVITY-THREAT-MODEL.md) | [ADR 0015](adr/0015-shell-native-completion-and-typed-quick-actions.md) plus a required future CP5 bridge ADR |
