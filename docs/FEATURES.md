...
| Direct OpenSSH review contract (non-activated M3) | Exact inventory-typed alias or literal-host grammar, F2/revision/executable/capability/trust binding, stale invalidation, and a complete disabled renderer-neutral review; no connection or PTY authority | PR/source: Windows model, hostile, redaction, responsive, accessibility, strict-lint, and architecture tests; native OpenSSH/PTY evidence remains external | [Connection Hub and SSH](user-guide/connection-hub-and-ssh.md#what-the-next-managed-ssh-slice-currently-means), [M3 testing](TESTING.md#m3-direct-openssh-review-contract) | [ADR 0012](adr/0012-first-party-ssh-and-session-launch-boundary.md), [Architecture](ARCHITECTURE.md#m3-direct-openssh-review-boundary) |
