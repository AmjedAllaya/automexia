...
D6.1-D6.5 provider slices remain planned or external. D6.0/M7's
authority-free capsule/authentication framework is complete locally, but it
adds no provider login or command execution. Its reusable
