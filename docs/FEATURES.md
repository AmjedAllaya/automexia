...
D6.1/M8 AWS, D6.2/M9 Azure, and D6.3/M10 Google Cloud source contracts are
complete locally and nonactivated; D6.4-D6.5 and all product/native provider
evidence remain planned or external. D6.0/M7's authority-free capsule/
authentication framework is complete locally, while D6.1-D6.3 add no live
provider login or command execution around the protected runner. Its reusable
