...
[Command Productivity](../../guide/shell-productivity.md). The concrete CP2/CP3 alias
and first-party pack specification is
[DevOps Quick Actions and persistent aliases](../../guide/shell-productivity.md). CP3.1
