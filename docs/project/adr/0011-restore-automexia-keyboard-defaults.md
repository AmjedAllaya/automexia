...
source by [ADR 0041](../../adr/0041-shell-owned-history-and-eof-shortcuts.md).
Other tab, navigation and clipboard decisions remain unchanged. Current fresh-
split and non-shell clone chords are governed by
