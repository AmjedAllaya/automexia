...
| [0012](adr/0012-first-party-ssh-and-session-launch-boundary.md) | SSH/session launch boundary (proposed) | The active schema-2 D0/D3 manual/trust/package/grant/platform/hermetic-fixture contract is mutation-checked while schema 1 remains immutable; no capability is enabled until ADR 0012 protected acceptance and native evidence pass. |
