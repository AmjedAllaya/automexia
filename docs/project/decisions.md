# Public architecture decision index mirror

The canonical index is [Public architecture decision index](../DECISIONS.md). This mirror lists decisions needed to understand the public free terminal.
