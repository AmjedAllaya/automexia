...
| Assurance | v0.4/S1 | **Fully implemented in source** | **Partial / external** | Exact deterministic visual hooks, Windows WGPU/CPU native/resource automation, separate bounded verifier phases, a strict 28-suite policy/validator with five 8,352-frame visual matrices, controlled workflow, and fail-closed stable-tag dependency are complete. Controlled Linux/macOS/named-GPU/elevated/accessibility evidence and approved visual matrices remain. |
