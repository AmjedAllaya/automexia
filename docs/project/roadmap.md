...
| DevOps | D0 | **Partial** | **Partial** | ADR 0012 is accepted; schema 3 ratchets immutable schema 1/2 with exact managed options and lifecycle/receipt/reconnect rules. Protected approvals and native execution remain. |
...
| SSH UX | D5.0-D5.2 | **Partial overall; D5.1 and nonactivated F5.1 source complete locally** | **Partial/blocked** | Exact managed argv, full-review/executable binding, actual child outcomes, notifications, bounded durable receipts, and stale-source reconnect preparation pass locally. Protected activation/attestation, real SSH/forced cleanup, M4/M5 routes/trust/tunnels, and native/accessibility proof remain. |
