...
| DevOps | D0 | **Partial** | **Partial** | ADR 0012 is accepted; schema 4 ratchets immutable schemas 1/2/3 with exact M3/M4 routes, trust/status, and lifecycle/receipt/reconnect rules. Protected approvals and native execution remain. |
...
| SSH UX | D5.0-D5.2 | **Partial overall; D5.1 and nonactivated F5.1/F5.2 source complete locally** | **Partial/blocked** | Typed direct/config-jump argv, full host-key/public-identity review, safe copy, review/executable binding, lifecycle, receipts, and reconnect pass locally. Protected activation/attestation, actual status/SSH execution, F5.3 tunnels, forced cleanup, and native/accessibility proof remain. |
