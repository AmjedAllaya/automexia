...
| CRUD and assurance | Pure parser only | Revisioned create/update/delete/replace/recover; 25 Windows / 27 Ubuntu-WSL unit and four public integration/property tests per host; 1,000 load cycles; Unicode/spaced roots; policy allowlists/mutations; nightly-compiled controlled Criterion benchmark | Hosted Windows/Linux/macOS and 30-day named-hardware evidence before release claim |
