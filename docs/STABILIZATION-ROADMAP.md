...
| CP3.2-CP3.3 packs and bridges | CP3.1 | Reviewed static Git/Docker/Kubernetes/OpenShift/Helm/Terraform/OpenTofu/AWS/Azure/GCP/SSH packs and trusted imports; no default short alias. | Not implemented; requires pack review and trust/import evidence. |
...
| Architecture | CP0 rejected all Quick Action runtime vocabulary | Exact five-file pure model (including nonactivated CP3.0 projection), eight-file CP2 application boundary plus two reviewed CP3.1 publication sources, and separate UI adapter allowlist; capability mutations reject filesystem/process/network/secret/grid/execution drift | CP3.1 publication stays app-owned; CP3.2 provider packs and D3 exact execution require separate gates |
