...
| CP3.3 trusted imports and task bridges | CP3.2 | Dry-run native-alias import and trusted explicit just/Task/mise task insertion. | **Not done:** requires trust, revocation, hostile import, and removal evidence. |
