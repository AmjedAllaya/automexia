...
| **Not done** | D6.1-D6.5 | AWS, Azure, Google Cloud, Kubernetes/OpenShift, Teleport, and OpenBao operation builders, transports, product login flows, and real native/provider evidence remain planned. |
