...
| **Not done** | D6.2-D6.5 | Azure, Google Cloud, Kubernetes/OpenShift, Teleport, and OpenBao adapters, product login flows, and real native/provider evidence remain planned. OpenBao implementation is blocked on proposed ADR 0024 acceptance. |
