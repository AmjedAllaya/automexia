...
| **Partially done** | D3 | The nonactivated broker binds exact package identity, grants, platform resolution, file identity, lifecycle, and redacted audit. Local CI now protects launch/capability authorities and counts only independent human approvals; real reviews, server-side enforcement, attestation, production UX/spawn, and native proof remain. |
