...
| **Not done** | D6.4-D6.5 | Kubernetes/OpenShift, Teleport, and OpenBao adapters, product login flows, and real native/provider evidence remain planned. OpenBao implementation is blocked on proposed ADR 0024 acceptance. |
