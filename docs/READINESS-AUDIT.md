...
| Coverage | LLVM coverage on the exact 2026-08-15 working tree passed at 49.51% global line coverage versus the 43.52% Windows baseline and 100.00% changed Automexia-owned executable lines. The checker supports explicit `WORKTREE` mode and includes untracked Rust files. |
