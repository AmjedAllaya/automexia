...
| v0.5 | Renderer-independent accessibility model, broader Loom/Miri, scoped mutation testing, and maintainable cargo-vet policy are designed | ADR-backed implementation, native assistive-technology evidence, mutation survivor triage, and named supply-chain audit ownership. |
