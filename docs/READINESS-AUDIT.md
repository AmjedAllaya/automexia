...
| v0.4 S1 structured/rendered visuals | Structured state, topmost Windows smoke, and bounded reviewed expected/actual/diff comparator are implemented | Record/approve the viewport/theme/font/DPI golden matrix, Linux/macOS frames, and human aesthetic review. |
