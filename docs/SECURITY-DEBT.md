...
| Hosted assurance not yet observed | Local dependency policy, architecture, identity, provenance, focused security regressions, and feature-gated test surfaces pass. | Require hosted Actions static analysis, fuzz, sanitizers, Miri, cross-platform jobs, signed artifacts, SBOMs, checksums, and provenance attestations before stable release. |
