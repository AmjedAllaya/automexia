...
| Provider-neutral connections, plans, direct/routed/tunnel review | Implemented but misplaced under DevOps context | `automexia-connectivity::connections` | Shared capability-free connectivity policy used by app/UI/providers | Moved source/tests/bench/fuzz; D0 schema 7 references the current owner, retains schemas 1-6 by exact digest, and keeps privileged review/launch in the application broker. |
