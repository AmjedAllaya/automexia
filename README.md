...
- [Situation-aware production operations direction](docs/SITUATION-AWARE-PRODUCTION-OPERATIONS.md)
- [Production operations experience summary](docs/SITUATION-AWARE-PRODUCTION-OPERATIONS-UX.md)
- [Optional LLM orchestration direction](docs/LLM-ORCHESTRATION-EXTENSION.md)
- [Testing](docs/TESTING.md)
- [Roadmap](docs/ROADMAP.md)
- [Decision index](docs/DECISIONS.md)
- [Public/private documentation policy](docs/PRIVATE-DOCUMENTATION-POLICY.md)
