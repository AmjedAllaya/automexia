...
fn m4_full_host_trust_and_public_identity_evidence_are_bound_and_redacted() {
    ...
    let reviewed = automexia_connectivity::connections::review_direct_openssh_m4(
        &profile,
        &plan,
        &observation,
        evidence.clone(),
...
fn m4_first_use_and_known_trust_show_complete_evidence_and_bind_fresh_reviews() {
    ...
    let first_use = automexia_connectivity::connections::review_direct_openssh_m4(
        &profile,
        &plan,
        &observation,
    ...
    let known = automexia_connectivity::connections::review_direct_openssh_m4(
        &profile,
        &plan,
        &observation,
